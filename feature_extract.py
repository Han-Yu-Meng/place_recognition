...
def accumulate_pcds(frame_list, target_pose):
    ...
    for frame in frame_list:
        ...
        # 将历史帧转换到当前帧坐标系 (World -> Target Body)
        # frame['pose'] 是 World -> Frame Body
        # T_relative = (World->TargetBody)^-1 * (World->FrameBody) = TargetBody->World * World->FrameBody = TargetBody->FrameBody
